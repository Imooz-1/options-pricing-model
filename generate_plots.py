...
1. Monte Carlo convergence (naive vs antithetic) against the analytical BS price
2. Greeks as a function of spot price
3. Delta-hedging P&L distribution
4. Hedging error vs rebalancing frequency
"""
...
print("Toutes les figures ont été générées dans", PLOTS_DIR)
